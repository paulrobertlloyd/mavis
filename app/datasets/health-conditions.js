export default {
  ...
  anxietyDisorder: {
    ...
    AnythingElse:
      'My child also has a history of sleep disturbances and struggles to fall asleep at night.',
    triageNote:
  ...
  autism: {
    ...
    AnythingElse:
      'My child also has a sensory processing disorder and can be sensitive to certain sounds and textures.',
    triageNote:
  ...
  depression: {
    ...
    AnythingElse:
      'My child also struggles with low energy and a lack of motivation, but has made progress with the help of therapy and medication.',
    triageNote:
  ...
  dyslexia: {
    ...
    AnythingElse:
      'My child also has difficulty with spatial awareness and can struggle with activities like sports and games.',
    triageNote:
  ...
  eczema: {
    ...
    AnythingElse:
      'My child also has a history of food allergies that can trigger their eczema.',
    triageNote:
      'Spoke with parent. Safe to vaccinate, but monitor for adverse reactions'
  },
  epilepsy: {
  ...
  learningDisability: {
    ...
    AnythingElse:
      'My child also struggles with attention and focus, but has made great progress with the help of support services.',
    triageNote:
