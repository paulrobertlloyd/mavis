...
import { RESPONSE_REFUSAL } from '../models/response.js'
...
export const getRefusalReason = (type) => {
  ...
  const refusalReasons = Object.values(RESPONSE_REFUSAL).filter((value) =>
    type !== 'flu' ? value !== RESPONSE_REFUSAL.GELATINE : value
  )
